...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a href="update_billing.jsp"><input class="colored" type="submit" value="Update Billing List"></a><br>
            <a href="delete_billing.jsp"><input class="colored" type="submit" value="Delete Billing from List"></a>
        </div>
