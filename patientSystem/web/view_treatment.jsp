...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a href="update_treatment.jsp"><input class="colored" type="submit" value="Update Treatment List"></a><br>
            <a href="delete_treatment.jsp"><input class="colored" type="submit" value="Delete Treatment from List"></a>
        </div>
