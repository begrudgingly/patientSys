...
<html>
    <head>
        ...
        <title>Delete Treatment Information</title>
    ...
    <body>
        ...
        <c:if test="${(consultID!=null)}" var="result">
            <c:catch var="exception">
                <sql:update var="result" dataSource="${myDatasource}">
                    DELETE FROM treatment WHERE consultID = ?
        ...
        <h1>Delete Treatment Information</h1>
     
        <form action="delete_treatment.jsp" method="POST">
