...
<html>
    ...
    <body>
        ...
        <c:if test="${(consultID!=null) && (staffID!=null) && (patientID!=null) && (dateRecorded!=null) && (illnessType!=null)}" var="result">
            <c:catch var="exception">
            <sql:update var="result" dataSource="${myDatasource}">
                UPDATE consultations SET staffID = ?, patientID = ?, dateRecorded = ?, illnessType = ? WHERE consultID = ?
        ...
        <h1>Update Consultation Information</h1>
        ...
        <table class="formTable">
               ...
               <td>
                   <select class="selector" name="consultID">
                       <sql:query var="result" dataSource="${myDatasource}">
                           SELECT consultID FROM consultations
                       </sql:query>
            ...
            <tr>
               <td>Staff ID</td>
               <td>
                   <select class="selector" name="staffID">
            ...
            <tr>
               <td>Patient ID</td>
               <td>
                   <select class="selector" name="patientID">
